...
const CancelButton= React.memo(() => {
  ...
  return (
    <button
      ...
      className="bg-transparent w-6 h-6 text-gray-500 rounded-2xl shadow-md hover:bg-slate-700 hover:text-white transition-all focus:outline-none focus:ring-2 focus:ring-blue-500"
    >
