  ...
  return (
    <div className="min-h-screen flex flex-col gap-3 bg-gradient-to-b from-[#F9F5FF] to-white md:pt-20 mx-6 md:mx-10 lg:mx-20 xl:mx-40">
        ...
        <div className="flex items-center gap-7 mt-5">
          ...
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-[#53389E]">{pet.name}'s Profile</h1>
            <p className="text-[#9E77ED] text-sm md:text-base">Complete health & nutrition overview</p>
          </div>
        </div>
